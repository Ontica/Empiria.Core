...
*  Type     : PartiesTaxDataTests                        License   : Please read LICENSE.txt file            *
*                                                                                                            *
*  Summary  : Parties tax data tests.                                                                        *
*                                                                                                            *
...
namespace Empiria.Tests.Parties {
  ...
  /// <summary>Parties tax data tests.</summary>
  public class PartiesTaxDataTests {
