...
module Empiria {
  ...
  export class Session {
    ...
    public static authenticate(apiKey: string, username: string, password: string): Session {
      var dataOperation = Empiria.DataOperation.parse("createEmpiriaSession",
    ...
    public close(): void {
      var dataOperation = Empiria.DataOperation.parse("closeEmpiriaSession", this.apiKey, this.token);
    ...
    public refresh(): void {
      var dataOperation = Empiria.DataOperation.parse("refreshEmpiriaSession", this.apiKey, this.token);
